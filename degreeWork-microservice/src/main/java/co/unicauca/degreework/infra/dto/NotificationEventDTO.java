...
public class NotificationEventDTO implements Serializable {
    ...
    public NotificationEventDTO(String eventType, String title, String modality, String recipientEmail,
                                String directorEmail, String coDirector1Email, String coDirector2Email) {
        this.eventType = eventType;
        this.title = title;
        this.modality = modality;
        this.recipientEmail = recipientEmail;
        this.directorEmail = directorEmail;
        this.coDirector1Email = coDirector1Email;
        this.coDirector2Email = coDirector2Email;
