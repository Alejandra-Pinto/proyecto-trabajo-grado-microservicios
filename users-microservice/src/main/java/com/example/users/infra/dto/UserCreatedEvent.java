...
/**
 * DTO que representa el mensaje que se enviará por RabbitMQ
 * cuando un usuario ha sido creado exitosamente.
 * 
 * Este mensaje puede ser escuchado por otros microservicios
 * (por ejemplo, Submission, Notification, etc.).
 */
